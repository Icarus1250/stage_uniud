     ...
     Fst2015v   CF   E             WORKSTN handler('FRMSRV(FRMHND)':QvgFrm)
     ...
     DQdtFrmDef      e ds                  extname(st2015v   :form) qualified
     D                                                              template

      * Strutture dati globali
     DQdgRtc           ds                  likeds(QdtRtc)
     DQdgPnv           ds                  likeds(QdtPnv)
     D$OCLGT         e ds                  extname(OCLGT00F)
     ...
     D h50nrg0                             like(QdtFrmDef.h50nrg0       )
      ...
      *=============================================================================================
        ...
        if CTDVSO>0;
          s(QvgFrm:'hf0lbldvso':%subst(%char(CTDVSO):5:2)+
                                '/'+%subst(%char(CTDVSO):3:2));
        else;
          s(QvgFrm:'hf0lbldvso':%subst(%char(CTDTOR):5:2)+
                               '/'+%subst(%char(CTDTOR):3:2));
        endif;

        QdgFrm.hf0dtor=CTDTOR;
        QdgFrm.hf0rvso=CTRVSO;
        QdgFrm.hf0rfrm=CTRFRM;
      ...
      *=============================================================================================
        ...
        //traduzione codice produzione
        QFPRFS='OCLGT00F';
        QFIDNT='CTAVOR';
        QFFLAG=CTAVOR;
        exsr chnqfl;
        QdgFrm.HF1AVOR=QFDSCR;
        ...
        QdgFrm.HF1DTRC=CTDTRC;
        QdgFrm.HF1NSRC=CTNSRC;
        QdgFrm.HF1DTPC=CTDTPC;
        QdgFrm.HF1NSPC=CTNSPC;
      ...
      *=============================================================================================
       ...
       QvlSqlStr = 'select +
                           ...
                           cddtpc +
                      from oclgd00f +
                    :where and cdaaor='+ %char(QprAaaOrd) +' and cdnror=+
                               ' + %char(QprNmrOrd) +' +
                    :order cdaaor DESC +
